	...
	render() {
		return (
			<div className="task-filter">
				<button className="task-filter__btn" onClick={this.handleOnClickAll}>
					All
				</button>
				<button className="task-filter__btn" onClick={this.handleOnClickP1}>
					P1
				</button>
				<button className="task-filter__btn" onClick={this.handleOnClickP2}>
					P2
				</button>
				<button className="task-filter__btn" onClick={this.handleOnClickP3}>
					P3
				</button>
			</div>
		);
